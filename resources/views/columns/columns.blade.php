...
@php
    $heads = ['#', 'Désignation', 'Rayon', 'Salle', ['label' => 'Actions', 'no-export' => true, 'width' => 30]];
        ...
        <tr>
            ...
            <td>
                ...
                <a class="btn btn-xs btn-default text-danger mx-1 shadow" title="Delete" data-effect="effect-scale"
                    data-id="{{ $column->id }}" data-name="{{ $column->name }}" data-toggle="modal"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">{{ __('boxflow.addColumn') }}</h4>
            ...
            <div class="modal-body">
                <form action="{{ route('columns.store') }}" method="post" autocomplete="off">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">{{ __('boxflow.name') }}</label>
                    ...
                    <select name="Site" class="form-control" required>
                        <option value="" selected disabled> -- {{ __('boxflow.selectSite') }} --
                        </option>
...
<div class="modal" id="modaldemo8">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">{{ __('boxflow.deleteColumn') }}</h6><button aria-label="Close" class="close"
            ...
            <form action="columns/destroy" method="post">
                ...
                {{ csrf_field() }}
                <div class="modal-body">
                    <p>{{ __('boxflow.confirmDeleteColumn') }}</p><br>
