      ...
      <"row" <"col-12" tr> >
        <"row" <"col-sm-12 d-flex justify-content-start" f> >';
          ...
          <tr>
            ...
            <td>
              <a class="btn btn-xs btn-default text-primary mx-1 shadow" title="Update" data-effect="effect-scale" data-id="{{ $x->id }}" data-name="{{ $x->name }}" data-ray_name="{{ $x->ray->name }}" data-site_name="{{ $x->ray->site->name }}" data-toggle="modal" href="#exampleModal2"><i class="fa fa-lg fa-fw fa-pen"></i></a>
