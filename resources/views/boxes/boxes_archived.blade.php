                ...
                <"row" <"col-sm-12 d-flex justify-content-start" f> >';
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @if ($box->status === 'Available' ) 
                            <x-adminlte-button label="Borrow" class="btn-sm bg-gradient-info" type="button" title="Emprunter" data-toggle="modal" data-target="#borrowModal" data-id="{{ $box->id }}" />
                            @endif
        ...
        <div class="modal-content">
            ...
            <form id="borrowForm" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <!-- <div class="form-group">
                        <label for="transmission_date">Transmission date</label>
                        <input type="date" class="form-control" id="transmission_date" name="transmission_date" required>
                    </div> -->
                    @php
                    $config = ['format' => 'L'];
                    @endphp
                    <x-adminlte-input-date name="transmission_date" id="transmission_date" :config="$config" placeholder="Choose a date..." required>
                    ...
                    $config = ['format' => 'L'];
                    @endphp
                    <x-adminlte-input-date name="return_date" id="return_date" :config="$config" placeholder="Choose a date..." required>
                        <x-slot name="appendSlot">
                            <div class="input-group-text bg-gradient-danger">
                                <i class="fas fa-calendar-day"></i>
                            </div>
