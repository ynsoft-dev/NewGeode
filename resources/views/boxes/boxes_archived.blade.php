                    ...
                    <tr>
                        ...
                        <td class="actions-column">
                            <div class="d-flex align-items-center">
                                ...
                                @if ($box->status === 'Available' )
                                <x-adminlte-button label="Borrow" class="btn-sm bg-gradient-info" type="button" title="Emprunter" data-toggle="modal" data-target="#borrowModal" data-id="{{ $box->id }}" style="width: 80px;" />

                                <x-adminlte-button label="Destruction" class="btn-sm bg-gradient-danger" type="button" title="plan destruction" data-toggle="modal" data-target="#destroyModal" data-id="{{ $box->id }}" style="width: 80px;" />
                                @endif
                            </div>
                        </td>
                    </tr>
            ...
            <form id="destroyForm" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col">
                            <label>
                                <input type="radio" name="destruction_option" value="unlimited" id="unlimitedOption"> Unlimited
                            </label>
                        </div>
                    </div>
                    <div class="modal-footer">
