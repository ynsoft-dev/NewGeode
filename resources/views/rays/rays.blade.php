      ...
      <"row" <"col-12" tr> >
        <"row" <"col-sm-12 d-flex justify-content-start" f> >';
          ...
          <tr>
            ...
            <td>{{$x->site->name}}</td>
            <td>
              <a class="btn btn-xs btn-default text-primary mx-1 shadow" title="Update" data-effect="effect-scale" data-id="{{ $x->id }}" data-name="{{ $x->name }}" data-site_name="{{ $x->site->name }}" data-toggle="modal" href="#exampleModal2"><i class="fa fa-lg fa-fw fa-pen"></i></a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Add Rays</h4>
      ...
      <div class="modal-body">
        <form action="{{ route('rays.store') }}" method="post" autocomplete="off">
          ...
          <div class="form-group">
            <label for="exampleInputEmail1">Name Ray:</label>
...
<div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Update Ray</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        ...
        <form action="rays/update" method="post" autocomplete="off">
          ...
          <div class="form-group">
            ...
            <label for="recipient-name" class="col-form-label">Ray</label>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content modal-content-demo">
      ...
      <form action="rays/destroy" method="post">
        ...
        {{ csrf_field() }}
        <div class="modal-body">
          <p>Are you sure you want to delete this ray ?</p><br>
